...
public interface AccountStateRepository extends JpaRepository<AccountState, Long> {
    ...
    Page<AccountState> tenant(@Param("brokerName") String brokerName, Pageable pageable);

    @Query("select a from AccountState a where a.brokerName = :brokerName")
    Page<AccountState> policies(@Param("brokerName") String brokerName, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity0_01 = :selectivity0_01")
    Page<AccountState> selector_0_01(@Param("selectivity0_01") boolean selectivity0_01, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity0_1 = :selectivity0_1")
    Page<AccountState> selector_0_1(@Param("selectivity0_1") boolean selectivity0_1, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity1 = :selectivity1")
    Page<AccountState> selector_1(@Param("selectivity1") boolean selectivity1, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity10 = :selectivity10")
    Page<AccountState> selector_10(@Param("selectivity10") boolean selectivity10, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity20 = :selectivity20")
    Page<AccountState> selector_20(@Param("selectivity20") boolean selectivity20, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity40 = :selectivity40")
    Page<AccountState> selector_40(@Param("selectivity40") boolean selectivity40, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity60 = :selectivity60")
    Page<AccountState> selector_60(@Param("selectivity60") boolean selectivity60, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity80 = :selectivity80")
    Page<AccountState> selector_80(@Param("selectivity80") boolean selectivity80, Pageable pageable);

    @Query("select a from AccountState a where a.selectivity100 = :selectivity100")
    Page<AccountState> selector_100(@Param("selectivity100") boolean selectivity100, Pageable pageable);

    @Query("select a from AccountState a where a.attribute0 = :attribute0")
    Page<AccountState> attr_count_1(@Param("attribute0") String attribute0, Pageable pageable);
    ...
    Page<AccountState> attr_count_5(
    ...
    Page<AccountState> attr_count_10 (
        @Param("attribute0") String attribute0,
        @Param("attribute1") String attribute1,
        @Param("attribute2") String attribute2,
        @Param("attribute3") String attribute3,
    ...
    Page<AccountState> attr_count_15 (
        @Param("attribute0") String attribute0,
        @Param("attribute1") String attribute1,
        @Param("attribute2") String attribute2,
        @Param("attribute3") String attribute3,
    ...
    Page<AccountState> attr_count_20 (
        @Param("attribute0") String attribute0,
        @Param("attribute1") String attribute1,
        @Param("attribute2") String attribute2,
        @Param("attribute3") String attribute3,
    ...
    Page<AccountState> attr_count_25 (
        @Param("attribute0") String attribute0,
        @Param("attribute1") String attribute1,
        @Param("attribute2") String attribute2,
        @Param("attribute3") String attribute3,
